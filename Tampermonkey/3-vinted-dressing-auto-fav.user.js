// ==UserScript==
// @name         3 - Vinted Dressing Auto Fav [ULTRA SCROLL + QTE]
// @namespace    https://github.com/ValentinGratz/Vinted-favorites-manager-
// @version      1.9.0-qte-field
// @description  [DRESSING] Met en fav tout un dressing avec choix du nombre + champ de saisie
...
async function start(){
    ...
    // --- PHASE 1 : SCROLL ULTRA POUR CHARGER ---
    ...
    // --- PHASE 2 : NOUVEAU PANEL AVEC CHAMP DE SAISIE ---
    ...
    chooser.innerHTML=`
        ...
        <p style="font-size:13px;color:#aaa;margin:0 0 12px">${toFav.length} articles non favs trouvés sur ${all.length} chargés</p>
        ...
        <p style="font-size:11px;color:#888;margin:10px 0 0 0">Conseil: reste sous 100 pour éviter le ban. Délai 1.2-3.2s entre chaque fav.</p>
    `;
    ...
    chooser.querySelector('#vc-start-qte').onclick=async ()=>{
        ...
        // --- PHASE 3 : FAV AVEC LIMITE CHOISIE ---
