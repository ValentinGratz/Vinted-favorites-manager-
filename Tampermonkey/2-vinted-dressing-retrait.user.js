...
(function() {
    ...
    async function start(){
        ...
        bar.style.cssText='position:fixed;top:0;left:0;width:100%;background:#0074de;color:white;padding:8px;text-align:center;z-index:9999999;font-family:sans-serif;font-size:13px';
        bar.textContent='⏳ Chargement complet du dressing...'; document.body.appendChild(bar);
